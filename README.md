About vaex-server-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vaex-server-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3622&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-server-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-server` can be installed with `conda`:
...
```
mamba install vaex-server
```

It is possible to list all of the versions of `vaex-server` available on your platform with `conda`:
...
```
mamba search vaex-server --channel conda-forge
```
...
mamba repoquery search vaex-server --channel conda-forge

# List packages depending on `vaex-server`:
mamba repoquery whoneeds vaex-server --channel conda-forge

# List dependencies of `vaex-server`:
mamba repoquery depends vaex-server --channel conda-forge
```
